...
# GOT
hist(InitialX[regions$got]$c.tot.tha/10, breaks = seq(0,80, by=2), main="Soil carbon in G�taland", xlab="kg/m2", xlim=c(0,20), ylim=c(0,1200))
...
# SN
hist(InitialX[regions$sn]$c.tot.tha/10, breaks = seq(0,80, by=2), main="Soil carbon in S�dra Norrland", xlab="kg/m2", xlim=c(0,20), ylim=c(0,500))
