...
# count soil C  
soilCbyLayer <- countSoilCstsp(output, species, gvrun=1, rotLength, simLength)
soilCstst <- (rowSums(soilCbyLayer$treeLitter)+rowSums(soilCbyLayer$gvLitter))/10000
save(output, soilCstst,file=outFile)
